...
public final class Constants {
  ...
  public static class IntakeConstants {
    ...
    public static final int RollersID = 7;
  ...
  public static class MechanismConstants {
    ...
    public static final double minIntakeVal = 19;
    public static final double minElevatorVal = 0;
    public static final double minElevatorValAlg = 6.3;
    public static final double minShoulderValAlg = 1.5;

    public static final double maxShoulderVal = 63.45;
    public static final double maxIntakeVal = -89.15;
   ...
   public static class PhotonVisionConstants {
        ...
        public static final Transform3d IntakeCamToRobot = new Transform3d(0,-0.0254,0.2159 +0.053975, new Rotation3d(0, Math.toRadians(-20), Math.toRadians(180)));
    ...
    public static class RedSidePoses {
        ...
        public static final Pose2d CLOSE_DESCORE = new Pose2d(14.673, 4, Rotation2d.fromDegrees(180 - 180));
        ...
        public static final Pose2d CLOSE_LEFT_DESCORE = new Pose2d(13.870, 2.628, Rotation2d.fromDegrees(120.84 - 180));
        ...
        public static final Pose2d FAR_LEFT_DESCORE = new Pose2d(12.275, 2.616, Rotation2d.fromDegrees(59.5 - 180));
        ...
        public static final Pose2d FAR_DESCORE = new Pose2d(11.460, 4, Rotation2d.fromDegrees(0 - 180));
        ...
        public static final Pose2d FAR_RIGHT_DESCORE = new Pose2d(12.263,5.422, Rotation2d.fromDegrees(-59.5 + 180));
        ...
        public static final Pose2d CLOSE_RIGHT_DESCORE = new Pose2d(13.858, 5.434, Rotation2d.fromDegrees(-119.5 + 180));
    ...
    public static class BlueSidePoses {
        ...
        public static final Pose2d CLOSE_2nd_DESCORE = new Pose2d(3.3, 4.27, Rotation2d.fromDegrees(-90));
        ...
        public static final Pose2d CLOSE_LEFT_2nd_DESCORE = new Pose2d(4.22, 5.2, Rotation2d.fromDegrees(-150));//-143.33
        ...
        public static final Pose2d FAR_LEFT__2nd_DESCORE = new Pose2d(5.22, 4.96, Rotation2d.fromDegrees(150));
        ...
        public static final Pose2d FAR_2nd_DESCORE = new Pose2d(5.83, 3.78, Rotation2d.fromDegrees(90));
        ...
        public static final Pose2d FAR_RIGHT_2nd_DESCORE = new Pose2d(4.84, 2.89, Rotation2d.fromDegrees(36));
        ...
        public static final Pose2d CLOSE_RIGHT_2nd_DESCORE = new Pose2d(3.68, 3.12, Rotation2d.fromDegrees(-30));
    ...
    public static class FRConstants {
        ...
        public static final InvertedValue driveInverted = InvertedValue.CounterClockwise_Positive;//counter clockwise
        public static final InvertedValue turnInverted = InvertedValue.Clockwise_Positive;

        public static final Rotation2d EncoderOffset = Rotation2d.fromDegrees(50.2734);
    ...
    public static class FLConstants {
        ...
        public static final InvertedValue driveInverted = InvertedValue.Clockwise_Positive;//clockwise
        public static final InvertedValue turnInverted = InvertedValue.Clockwise_Positive;

        public static final Rotation2d EncoderOffset = Rotation2d.fromDegrees(291.97265);
        public static final SensorDirectionValue EncoderReversed = SensorDirectionValue.CounterClockwise_Positive;
    ...
    public static class BRConstants {
        ...
        public static final Rotation2d EncoderOffset = Rotation2d.fromDegrees(38.671875);
        public static final SensorDirectionValue EncoderReversed = SensorDirectionValue.CounterClockwise_Positive;
    ...
    public static class BLConstants {
        ...
        public static final Rotation2d EncoderOffset = Rotation2d.fromDegrees(210.7617);
        public static final SensorDirectionValue EncoderReversed = SensorDirectionValue.CounterClockwise_Positive;

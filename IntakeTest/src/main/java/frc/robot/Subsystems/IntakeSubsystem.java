...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public static void configurePivotMotor(){
    ...
    pivotConfig.MotionMagic.MotionMagicCruiseVelocity = 40; // Target cruise velocity of 80 rps
    pivotConfig.MotionMagic.MotionMagicAcceleration = 80;// double your cruise velocity
